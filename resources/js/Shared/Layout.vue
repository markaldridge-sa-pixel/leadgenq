    ...
    <div class="md:flex md:flex-col">
      <div class="md:flex md:flex-col md:h-screen">
        <div class="md:flex md:flex-shrink-0">
          <div class="flex items-center justify-between px-6 py-4 bg-indigo-900 md:flex-shrink-0 md:justify-center md:w-56">
            <Link class="mt-1" href="/">
              <logo class="fill-indigo-600" width="360px" height="125px" />
            </Link>
            <dropdown class="md:hidden" placement="bottom-end">
              ...
              <template #dropdown>
                <div class="mt-2 px-8 py-4 bg-indigo-600 rounded shadow-lg">
                  <main-menu />
                </div>
              </template>
            </dropdown>
            ...
            <dropdown class="mt-1" placement="bottom-end">
              ...
              <template #dropdown>
                <div class="mt-2 py-2 text-sm bg-white rounded shadow-xl">
                  ...
                  <Link class="block px-6 py-2 hover:text-white hover:bg-indigo-600" href="/users">Manage Users</Link>
        ...
        <div class="md:flex md:flex-grow md:overflow-hidden">
          <main-menu class="hidden flex-shrink-0 p-12 w-56 bg-indigo-600 overflow-y-auto md:block" />
